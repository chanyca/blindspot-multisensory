...
for i = 1:length(matFiles)
    ...
    % Create a table
    T = table(trial_no', n_flash, n_beep, direction, blindspot,  response', response_type, ...
              'VariableNames', {'trial_no', 'n_flash', 'n_beep', 'direction', 'blindspot', 'response', 'response_type'});
    ...
    % Rearrange columns
    T = T(:, {'subj_id', 'eye', 'trial_no', 'n_flash', 'n_beep', 'direction', 'blindspot', 'response', 'response_type'});
